...
\newcommand{\hell}{Codificação Digital de Sinais}		%nome do arquivo
% \renewcommand{\autor}{\ziul}							%criador do pdf - só observado nos detalhes do pdf
\newcommand{\assunto}{Codificação Aritimética}			%Nome do experimento
\newcommand{\ver}{\assunto}						%numeração do experimento
\newcommand{\professor}{Ricardo Lopes de Queiroz}
...
\newcommand{\luiz}{\href{http://lattes.cnpq.br/1109478949026592}{Luiz Fernando Oliveira}}	%Para link
